...
build: $(BIN) files | $(BIN)/responseinfo.o $(BIN)/server.o $(BIN)/responsehelper.o $(BIN)/requestinfo.o $(BIN)/clienthandler.o $(BIN)/requesthandler.o
	$(CC) $(CFLAGS) $(BIN)/server.o $(BIN)/responseinfo.o $(BIN)/responsehelper.o $(BIN)/requestinfo.o $(BIN)/clienthandler.o $(BIN)/requesthandler.o -o $(BIN)/Server.exe
